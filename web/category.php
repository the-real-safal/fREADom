...
<style>
    ...
    width: 25%;
    height: auto;
    transform: translate(-120px,-1045px);
     }
     .recent-post-container {
    float: right;
    width: 22%;
    height: auto;
    transform: translate(310px,-915px);
     }
    </style>
  </style>
</head>
                ...
                <div class="post-container">
                  ...
                  ?>
                    <div class="post-content">
                        <div class="row">
                            <div class="col-md-4">
                              <a class="post-img" href="single.php?id=<?php echo $row['post_id']; ?>"><img src="../php/Admin/upload/<?php echo $row['post_img']; ?>" alt=""/></a>
                            </div>
                            <div class="col-md-8">
